...
class AppColors {
  ...
  static final Color ecommerceBackground = Color.fromARGB(234, 255, 255, 255);
  static const Color shadowColor = Color.fromARGB(255, 205, 205, 209);
  static final Color main = Color.fromARGB(255, 240, 132, 9);
}
